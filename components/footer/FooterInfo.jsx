        ...
        <div class="a">
          <div class="mb hd ca">
            <div class="bc pl/2 nd df">
              <div>
                <h1 class="ug fh mh ua">
                  Hey There 👋 I am
                  <span class="dh jh wg zj kk hh ak pk kb bb">
                    {" "}
                    Daniel Jack{" "}
                  </span>
                </h1>
                <h2 class="eh lh _g lk oa">
                  Professional
                  <span class="jh">Graphic Designer </span>
                </h2>
                <p class="tc eh lh ug ih cb">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Aenean interdum consequat convallis.
                </p>
                <div class="mb id">
                  <a
                    href="javascript:void(0)"
                    class="ug fh kh pe kf lf pa yi si td ai ci ei"
                  >
                    Contact Me
                  </a>
                  <a
                    href="javascript:void(0)"
                    class="ug fh kh qe kf lf yi si td ai ci ei"
                  >
                    Learn More
                  </a>
                </div>
            ...
            <div class="bc pl/2 md df">
              <div class="e db al z 2xl:ud-absolute 2xl:ud-bottom-0 2xl:ud-right-40">
                <img src="images/hero-image.png" alt="image" class="oc fa" />
