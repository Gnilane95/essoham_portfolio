...
export default function publications() {
  const publications = [
    ...
    },
    {
      ...
      authors:
        "Hubert Bassene, El Hadji Amadou Niang, Florence Fenollar, Dipankar Bachar, Souleymane Doucouré, Essoham Ali, Caroline Michelle, Didier Raoult, Cheickh Sokhna and Oleg Mediannikov",
      year: "2018",
          ...
          {publications.map((publication) => (
            <div className="shadow-lg p-7 mb-16" key={publication.id}>
              ...
              <div className="lg:flex lg:justify-between lg:items-center">
                ...
                <Link
                  href={publication.to}
                  className="btn sm:btn-sm lg:btn-sm md:btn-md border-none bg-amber-700 sm:mt-5 lg:mt-0 px-5 hover:bg-slate-100 hover:text-gray-800"
                >
                  Click to see
                </Link>
              </div>
